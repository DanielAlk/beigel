...
class PromotionsControllerTest < ActionController::TestCase
  ...
  test "should create promotion" do
    assert_difference('Promotion.count') do
      post :create, promotion: { promotionable_id: @promotion.promotionable_id, promotionable_type: @promotion.promotionable_type }
    end
  ...
  test "should update promotion" do
    patch :update, id: @promotion, promotion: { promotionable_id: @promotion.promotionable_id, promotionable_type: @promotion.promotionable_type }
    assert_redirected_to promotion_path(assigns(:promotion))
  end
